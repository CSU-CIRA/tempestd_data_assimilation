...
!***
!
PRINT("(A,1X,F5.1,A,1X,F6.1)"),"RECT_LAT_BEGIN:",RECT_LAT_BEGIN,  &
                             ", RECT_LON_BEGIN:",RECT_LON_BEGIN
PRINT("(A,1X,F4.2,A,1X,F4.2)"),"RECT_DELTA_LAT:",RECT_DELTA_LAT, &
...
RECLEN=4*RECT_NXP*RECT_NYP
PRINT*," "
PRINT*, "Writing: obs_rect_648_tb.dat"
OPEN(UNIT=29,FILE="obs_rect_648_tb.dat",FORM="UNFORMATTED",ACCESS="DIRECT",  &
     STATUS="REPLACE",RECL=RECLEN)
