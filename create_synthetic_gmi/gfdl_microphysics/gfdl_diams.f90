...
!*** Model dimensions
!
character(len=100), parameter :: data="/scratch1/NESDIS/nesdis-rdo2/Heather.Cronk/control_dec2018/read_nemsio/control_dec2018/"
character(len=6),  parameter :: time="000000"
INTEGER(kind=4),   parameter :: NZP=64, NXP=1536, NYP=768
...
ALLOCATE(RVP(NZP,NXP,NYP), SPH(NZP,NXP,NYP), PRESS(NZP,NXP,NYP), &
         TEMPK(NZP,NXP,NYP), RHO_AIR(NZP,NXP,NYP), DIAM(NZP,NXP,NYP), & 
...
!
print("(A)")," "
print("(A,1X,A)"),"Reading",trim(data)//"CLWMR"//time
IREC = 1
OPEN(UNIT=29,FILE=trim(data)//"CLWMR"//time,FORM="UNFORMATTED", &
     ACCESS="DIRECT",STATUS="OLD",RECL=LRECLEN)
DO K = 1, NZP
...
!
print("(A)")," "
print("(A,1X,A)"),"Reading",trim(data)//"RWMR"//time
IREC = 1
OPEN(UNIT=29,FILE=trim(data)//"RWMR"//time,FORM="UNFORMATTED", &
     ACCESS="DIRECT",STATUS="OLD",RECL=LRECLEN)
DO K = 1, NZP
 READ(29,REC=IREC)((MASS(K,I,J),I=1,NXP),J=1,NYP)
 IREC = IREC + 1
...
!
print("(A)")," "
print("(A,1X,A)"),"Reading",trim(data)//"ICMR"//time
IREC = 1
OPEN(UNIT=29,FILE=trim(data)//"ICMR"//time,FORM="UNFORMATTED", &
     ACCESS="DIRECT",STATUS="OLD",RECL=LRECLEN)
DO K = 1, NZP
 READ(29,REC=IREC)((MASS(K,I,J),I=1,NXP),J=1,NYP)
 IREC = IREC + 1
...
!
print("(A)")," "
print("(A,1X,A)"),"Reading",trim(data)//"SNMR"//time
IREC = 1
OPEN(UNIT=29,FILE=trim(data)//"SNMR"//time,FORM="UNFORMATTED", &
     ACCESS="DIRECT",STATUS="OLD",RECL=LRECLEN)
DO K = 1, NZP
 READ(29,REC=IREC)((MASS(K,I,J),I=1,NXP),J=1,NYP)
 IREC = IREC + 1
...
!
print("(A)")," "
print("(A,1X,A)"),"Reading",trim(data)//"GRLE"//time
IREC = 1
OPEN(UNIT=29,FILE=trim(data)//"GRLE"//time,FORM="UNFORMATTED", &
     ACCESS="DIRECT",STATUS="OLD",RECL=LRECLEN)
DO K = 1, NZP
 READ(29,REC=IREC)((MASS(K,I,J),I=1,NXP),J=1,NYP)
 IREC = IREC + 1
